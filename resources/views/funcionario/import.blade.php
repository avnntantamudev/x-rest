@section('script')
    ...
    <!-- tawk chat JS
        ============================================ -->
    <script src="{{('/assetss/js/tawk-chat.js')}}"></script>

    <script src="{{('/assetss/js/data-table/jquery.dataTables.min.js')}}"></script>
    <script src="{{('/assetss/js/data-table/data-table-act.js')}}"></script>
    <!-- main JS
@endsection
...
@section('headlink')
    ...
    <!-- meanmenu CSS
        ============================================ -->
    <link rel="stylesheet" href="{{('/assetss/css/meanmenu/meanmenu.min.css')}}">
    <!-- animate CSS
        ============================================ -->
    ...
    <link rel="stylesheet" href="{{('/assetss/css/wave/button.css')}}">
    ...
    <link rel="stylesheet" href="{{('/assetss/css/jquery.dataTables.min.css')}}">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div class="logo-area">
                    <h1>
                        <a href="{{ROUTE('funcionario.home')}}">X-REST</a>
                    </h1>
                </div>
            </div>
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                <div class="header-top-menu">
                    <ul class="nav navbar-nav notika-top-nav">
                        <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><span><i class="notika-icon notika-menus"></i></span><div class="spinner4 spinner-4"></div><div class="ntd-ctn"></div></a>
                ...
                <div class="mobile-menu">
                    <nav id="dropdown">
                        <ul class="mobile-menu-nav">
                            ...
                            <li><a data-toggle="collapse" data-target="#demoevent" href="#">VENDAS</a>
                                <ul id="demoevent" class="collapse dropdown-header-top">
                                    <li><a href="{{route('funcionario.cliente')}}">Cliente</a>
                                    </li>
                                    <li><a href="invoice.html">Documento</a>
                                    </li>
                                    <li><a href="typography.html">Cambio</a>
                                    </li>
                                </ul>
                            </li>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                    <li><a data-toggle="tab" href="#Home"><i class="notika-icon notika-house"></i> Home</a>
                        ...
                        <li class="active"><a data-toggle="tab" href="#Page"><i class="notika-icon notika-support"></i> VENDAS</a>
                    </li>
                    <li><a data-toggle="tab" href="#mailbox"><i class="notika-icon notika-mail"></i>COMPRAS</a>
                    </li>
                    <li><a data-toggle="tab" href="#Interface"><i class="notika-icon notika-edit"></i>INVENTÁRIO</a>
                ...
                <div class="tab-content custom-menu-content">
                    ...
                    <div id="Page" class="tab-pane active notika-tab-menu-bg animated flipInX">
                        <ul class="notika-main-menu-dropdown">
                            ...
                            <li><a href="{{route('funcionario.documento')}}">Documento</a>
                            </li>
                            <li><a href="typography.html">Cambio</a>
                            </li>
                        </ul>
